...
const Projects = () => {
  ...
  const project = [
    ...
    },
    {
      ...
      img2: "",
      desc: "Temp description: is an online volunteer management solution that helps non-profit organizations streamline employee scheduling, event planning and fundraising operations ",
    ...
    },
    {
      ...
      img2: "",
      desc: "Temp description: is an online volunteer management solution that helps non-profit organizations streamline employee scheduling, event planning and fundraising operations on a unified platform",
      title: " Signup progress",
